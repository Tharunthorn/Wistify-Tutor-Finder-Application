...
SECRET_KEY = 'django-insecure-2vs$g^int$(3q4t69=&n=zh1vrhzmi=-13or&9vg9cm^&hxvf-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://regular-civet-learning.ngrok-free.app', '*']
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': '155016687365-kh2ue5anrfs7an9a6elp6pp9qvbob4is.apps.googleusercontent.com',
            'secret': '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',
            'key': '',
        },
        'SCOPE': ['profile','email', ],
